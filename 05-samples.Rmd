...
**Prior to using the data in RStudio Cloud you need to put the data into RStudio Cloud. You need to 1) download the file to your local computer and then 2) upload it to RStudio Cloud.**
