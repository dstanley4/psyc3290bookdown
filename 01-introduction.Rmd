...
1. Create a folder on your computer called "psyc3290_project_1". Be sure you know where you create this folder so you can find it again easily.
...
3. Place the data_okcupid.csv file into the psyc3290_project_1 folder.
