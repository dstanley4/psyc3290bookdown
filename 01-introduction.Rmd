...
Download the data_ratings.csv file from the Lab 1 folder on Courselink. Then go back to RStudio Cloud. Use the **Upload** button in RStudio Cloud to import the data_ratings.csv file. The button is displayed below.

```{r uploadbutton, fig.cap="Screenshot of upload button", echo = FALSE, out.width="35%"}
